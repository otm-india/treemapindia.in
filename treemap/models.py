...
class Tree(models.Model, ManagementMixin, PendingMixin):
    ...
    tree_number = models.IntegerField(null=True, blank=True)
    prabhagid = models.IntegerField(null=True, blank=True)
    clusterid = models.IntegerField(null=True, blank=True)
    propertyid = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["property_type"])

    #tree_name = species
    #botanical_name
    girth_m  = models.IntegerField(null=True, blank=True)
    height_m  = models.IntegerField(null=True, blank=True)
    nest = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["tree_objects"])
    burrows = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["tree_objects"])
    flowers = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["tree_objects"])
    fruits = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["tree_objects"])
    nails = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["tree_objects"])
    poster = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["tree_objects"])
    wires = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["tree_objects"])
    tree_guard = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["tree_objects"])
    other_nuisance = models.BooleanField(default=False)
    other_nuisance_desc = models.CharField(max_length=256, null=True, blank=True)
    health_of_tree = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["health"]) 
    ground_type  = models.CharField(max_length=256, null=True, blank=True, choices=settings.CHOICES["ground_type"]) 
    ground_desc =  models.CharField(max_length=256, null=True, blank=True)
    risk_due_to_tree =  models.CharField(max_length=256, null=True, blank=True)
    risc_desc =  models.CharField(max_length=256, null=True, blank=True)
    refer_to_dept = models.CharField(max_length=256, null=True, blank=True)
    special_other  = models.CharField(max_length=256, null=True, blank=True)
    special_other_desc  = models.CharField(max_length=256, null=True, blank=True)
    latitude = models.FloatField(null=True, blank=True)
    longitude = models.FloatField(null=True, blank=True)
    creation_date = models.DateTimeField(null=True, blank=True)
    device_id  = models.CharField(max_length=12, null=True, blank=True)
    surveyor_id  = models.CharField(max_length=256, null=True, blank=True)
    ...
    photo_focused1 = ImageField(upload_to=get_photo_path, null=True, blank=True) 
    photo_focused2 = ImageField(upload_to=get_photo_path, null=True, blank=True)  
    photo_panorama1 = ImageField(upload_to=get_photo_path, null=True, blank=True) 
    photo_panorama2 = ImageField(upload_to=get_photo_path, null=True, blank=True) 
    photo_other = ImageField(upload_to=get_photo_path, null=True, blank=True)
