...
SITE_LOCATION = 'Pune'
COMPLETE_ARRAY = ['species','condition','powerline_conflict_potential','canopy_height','canopy_condition','dbh','width','length','type']
REGION_NAME = 'Pune'
PENDING_ON = False
...
CHOICES = {
    ...
    'health': [
        ...
        ("Diseased", "Diseased"),
        ("Injured", "Injured"),
        ("Heavily Lopped", "Heavily Lopped")
        ],
    'ground_type': [
        ("Open Soil", "Open soil"),
        ("Compressed soil", "Compressed soil"),
        ("Cemented", "Cemented"),
        ("Tiled", "Tiled"),
